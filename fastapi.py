...
!curl -X POST https://17d4-34-168-137-223.ngrok-free.app/predict/ -H "Content-Type: application/json" -d '{"data": [0.812959, 0, -0.560700, 1.701895, -1.478080, -0.121517, 0.125643, 0, 0.489832, 0.340994]}'
